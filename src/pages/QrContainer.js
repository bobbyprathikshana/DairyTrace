			  ...
			  return(
			   ...
			   <dl key={key}>
				  ...
				  <dt style={{float:'left',clear:'left',marginRight:'5px'}}>Certification Id :</dt><dd> {product.certi}</dd>
				  		 <Accordion>
       <br/>
            <AccordionItem title={ <Button  variant="primary">View Details </Button>} expanded={1 === 0}>
			 <br/>
           ...
           {this.props.distributes.filter((distribute) => distribute.disowner == ownerrole.Downer).map((distribute, key) => {
			  return(
			   ...
			   <dl key={key}>
				  ...
				  <dt style={{float:'left',clear:'left',marginRight:'5px'}}>Certification Id :</dt><dd> {distribute.discerti}</dd>
				   <Accordion>
       <br/>
            <AccordionItem title={<Button  variant="primary">View Details </Button>} expanded={1 === 0}>
			<br/>
				 <dt style={{float:'left',clear:'left',marginRight:'5px'}}>Purchase Time              :</dt><dd> {distribute.distime}</dd>	
				 ...
				 <dt style={{float:'left',clear:'left',marginRight:'5px'}}>Milk Condition             :</dt><dd> {distribute.discondition}</dd>
            </AccordionItem>
          ...
          {this.props.retails.filter((retail) => retail.reowner == ownerrole.Rowner).map((retail, key) => {
			  return(
			   ...
			   <dl key={key}>
				  ...
				  <dt style={{float:'left',clear:'left',marginRight:'5px'}}>Certification Id : </dt><dd style={{marginLeft:'0px'}}>{retail.recerti}</dd>
				   <Accordion>
       <br/>
            <AccordionItem title={<Button  variant="primary">View Details </Button>} expanded={1 === 0}>
			<br/>
				 <dt style={{float:'left',clear:'left',marginRight:'5px'}}>Purchase Time              :</dt><dd> {retail.retime}</dd>	
				 ...
				 <dt style={{float:'left',clear:'left',marginRight:'5px'}}>Milk Condition             :</dt><dd> {retail.recondition}</dd>
            </AccordionItem>
